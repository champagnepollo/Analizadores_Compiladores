...
//        tablaSimbolos.add(new ElementoTablaSimbolos("char|double|float|int|long|short|string","tipo",null));
        tablaSimbolos.add(new ElementoTablaSimbolos("","reservada",null));
        ...
        tablaSimbolos.add(new ElementoTablaSimbolos("true|false","boolean",null));
        ...
        tablaSimbolos.add(new ElementoTablaSimbolos("char","tipo",null));
        ...
        tablaSimbolos.add(new ElementoTablaSimbolos("double","tipo",null));
        ...
        tablaSimbolos.add(new ElementoTablaSimbolos("float","tipo",null));
        ...
        tablaSimbolos.add(new ElementoTablaSimbolos("int","tipo",null));
        tablaSimbolos.add(new ElementoTablaSimbolos("interface","interface",null));
        tablaSimbolos.add(new ElementoTablaSimbolos("long","tipo",null));
        ...
        tablaSimbolos.add(new ElementoTablaSimbolos("short","tipo",null));
